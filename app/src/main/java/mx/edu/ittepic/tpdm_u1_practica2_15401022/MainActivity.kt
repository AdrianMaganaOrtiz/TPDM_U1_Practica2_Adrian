package mx.edu.ittepic.tpdm_u1_practica2_15401022
...
class MainActivity : AppCompatActivity() {
    ...
    fun acercaDe(){
        val alerta = AlertDialog.Builder(this)
        alerta.setIcon(android.R.drawable.ic_dialog_alert).setTitle("Acerca de...").setMessage("(C) Garcia Gomez Miguel Angel").setPositiveButton("Aceptar"){dialogInterface, i ->
        }.show()
    }
}